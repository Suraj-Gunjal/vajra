        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: "#6B7280" }}>
              Deep dive into historical scan logs, AI reasoning, and adversarial
              resilience.
            </p>
          </div>
          <motion.button
        ...
        {loading ? (
          ...
          <GlassCard className="text-center py-16">
            ...
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>
              Your database is clean. Start scanning endpoints or emails to
              generate AI reports.
            </p>
          ...
          <div className="space-y-4">
            {reports.map((report, i) => (
              ...
              >
                <GlassCard
                  className={`cursor-pointer transition-all duration-300 ${selectedReport?.scan_id === report.scan_id ? "ring-1 ring-cyan-500/50" : "hover:bg-[rgba(255,255,255,0.02)]"}`}
                  onClick={() => viewDetail(report.scan_id)}
                >
                  ...
                  <AnimatePresence>
                    {selectedReport?.scan_id === report.scan_id && (
                      ...
                      >
                        <div
                          className="mt-6 pt-6 grid grid-cols-1 lg:grid-cols-2 gap-6"
                          style={{
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            {selectedReport.explanation && (
                              ...
                              >
                                ...
                                {selectedReport.explanation.recommended_actions
                                  ?.length > 0 && (
                                  <div>
                                    ...
                                    <ul className="space-y-1">
                                      {selectedReport.explanation.recommended_actions.map(
                                        (act, idx) => (
                                          <li
                                            key={idx}
                          ...
                          <div
                            ...
                            style={{
                              background:
                                "linear-gradient(145deg, rgba(249,115,22,0.05) 0%, rgba(0,0,0,0.4) 100%)",
                          ...
                          >
                            ...
                            <p className="text-xs text-gray-400 mb-6">
                              Hackers use "mutations" (like invisible zeroes,
                              typos, or encoded characters) to bypass AI
                              firewalls. We can automatically mutate this threat
                              in massive quantities to see if your AI wall holds
                              up.
                            </p>
                            ...
                            {!selectedReport.adversarial ? (
                              <div className="flex-1 flex flex-col items-center justify-center py-6 text-center">
                                <motion.button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleAdversarial(report.scan_id);
                                  }}
                                  disabled={
                                    adversarialLoading ||
                                    !selectedReport.detections?.some(
                                      (d) => d.detected,
                                    )
                                  }
                                ...
                                {!selectedReport.detections?.some(
                                  ...
                                  <p className="text-[10px] text-gray-500 mt-3">
                                    Cannot stress-test benign completely safe
                                    content.
                                  </p>
                                )}
                              </div>
                              ...
                              <div className="space-y-4">
                                ...
                                {selectedReport.adversarial.evasions_missed >
                                0 ? (
                                  <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                                    ...
                                    <p className="text-xs text-gray-400">
                                      The AI successfully blocked the original
                                      threat, but when hackers applied{" "}
                                      <strong>
                                        {selectedReport.adversarial.mutations
                                          ?.filter((m) => m.evasion_successful)
                                          .map((m) =>
                                      ...
                                      , the AI failed to recognize it and let it
                                      through. You must harden the prompt
                                      injection models against this specific
                                      bypass technique.
                                    </p>
                                  </div>
                                ) : (
                                  <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                                    ...
                                    <p className="text-[10px] text-gray-400 mt-1">
                                      ...
                                      heavily mutated bypassing attacks at the
                                      AI layer, and it caught 100% of them. Your
                                      current model thresholds are highly robust
